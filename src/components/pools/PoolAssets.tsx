...
export const PoolAssets = () => {
    ...
    return (
        <>
            <Table sticked headerLined shadow={false} className={"skinny-rows"} aria-label="pool-assets-acc">
                <Table.Header>
            ...
            <Table sticked headerLined shadow={false} className={"skinny-rows"} aria-label="pool-assets-rwa">
                <Table.Header>
