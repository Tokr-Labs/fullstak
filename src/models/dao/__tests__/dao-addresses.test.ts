...
test("that dao addresses are parsed correctly", () => {
    ...
    const input = {
        "realm": "BAygayfvMJo6kgm9294chhp9e3Jno96bibNqR2bU3ovq",
        "authority": "4ticUQxtxcyHJxJdT3jeucbiCxXonQcAnNCGaZkwUVPb",
        "owner": "33Vv9S6gpe6D4ZgE25F6moraDpTjiDYUMbSVBisg4Ymz",
        "governance": {
            "lp_governance": "H9H1MgFMk1JqwjoFjgaJVz8jjyDrWQTmtPKJjGoj69fg",
            "distribution_mint_governance": "6BsdgzUKkV5CgRjnG9opWewNuUDwxVAafe8sh8ooDJDW",
            "delegate_mint_governance": "DSYk7wNGsub5P1uHsPbNNWgk72J3RdpVX6qtKhb8hb47"
        },
        "mint": {
    ...
    expect(info.realm!.toBase58()).toEqual(input.realm);


    expect(governance.lpGovernance!.toBase58()).toEqual(input.governance.lp_governance);
    expect(governance.distributionMintGovernance!.toBase58()).toEqual(input.governance.distribution_mint_governance);
    expect(governance.delegateMintGovernance!.toBase58()).toEqual(input.governance.delegate_mint_governance);
